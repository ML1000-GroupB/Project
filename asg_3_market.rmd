...
```{r, warning=FALSE, fig.cap= "Bar chart of Instacart orders showing the number of orders by day of the week. It is assumed for order_dow that 0=Sunday, 1=Monday, 2=Wednesday... and so on until 6=Saturday. Sunday, Monday and Saturday appear to be the most common days where people place their orders."}
...
```{r, fig.cap="Relative Item Frequency Plot for top 20 Ordered Products from Instagram training dataset"}
